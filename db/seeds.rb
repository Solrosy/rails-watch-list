...
list1 = List.create(name: "Sonjas Movies")
List.create(name: "Linneass Movies")
List.create(name: "Tims Movies")
puts "Lists created"


Bookmark.create(comment: "Bookmark comment", movie: movie1, list: list1)
Bookmark.create(comment: "Bookmark comment", movie: movie2, list: list1)
